...
public struct Swift_Tests_Vectors: FlatBufferObject, Verifiable {
  ...
  public static func fromByteBuffer(_ bb: ByteBuffer) -> Swift_Tests_Vectors { return getRootAsVectors(bb: bb) }
  ...
  public var none_AsBuffer: UnsafeBufferPointer<UInt64> { return _accessor.getBufferPointer(at: VTOFFSET.none_.v) ?? .init(start: nil, count: 0) }
  ...
  public var emptyAsBuffer: UnsafeBufferPointer<UInt64> { return _accessor.getBufferPointer(at: VTOFFSET.empty.v) ?? .init(start: nil, count: 0) }
  ...
  public var arrayAsBuffer: UnsafeBufferPointer<UInt64> { return _accessor.getBufferPointer(at: VTOFFSET.array.v) ?? .init(start: nil, count: 0) }
